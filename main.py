...
# HTML Content (Embedded for portability)
...
if __name__ == "__main__":
    try:
        webview.create_window('AionMind Fixed', html=html_content, width=1000, height=800)
        webview.start()
        ...
        root = tk.Tk()
        root.withdraw()
        messagebox.showerror("Error", f"Failed to start WebView: {str(e)}")
